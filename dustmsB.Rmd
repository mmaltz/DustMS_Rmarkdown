...
#otu.taxa has the sample name (sample IDs as rows) and then the taxonomy column split out by taxonomic level
#otu.comm has OTUID as columns, and the sample IDs as rows
